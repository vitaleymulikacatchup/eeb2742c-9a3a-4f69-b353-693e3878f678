...
export const metadata: Metadata = {
  title: "Burger King - Flame-Grilled Burgers & Fast Food",
  description: "Enjoy flame-grilled burgers, crispy fries, and quality meals. Find Burger King locations near you for dine-in, drive-thru, or delivery.",
  keywords: "burger king, flame grilled burgers, fast food, whopper, chicken sandwich, restaurant",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Burger King - Flame-Grilled Perfection",
    description: "Experience the taste of flame-grilled burgers and your favorite meals",
    url: "https://burgerking.example.com",
    siteName: "Burger King",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1765271276658-0xypzl6u.jpg",
        alt: "Flame grilled Whopper burger"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Burger King - Flame-Grilled Burgers",
    description: "Order your favorite flame-grilled meals from Burger King today",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1765271276658-0xypzl6u.jpg"]
  }
};
